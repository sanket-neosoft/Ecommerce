                    ...
                    <div class="card-body">
                        <table id="banner" class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="{{ url('banners/' . $banner->image) }}" alt="{{ $banner->banner_image }}" style="height: 5rem; object-fit: cover; object-position: center"></td>
        ...
        $(".edit").on("click", function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#id").val(response.id);
                    $("#preview").attr("src", "Banners/" + response.image);
                }
            });
        });
